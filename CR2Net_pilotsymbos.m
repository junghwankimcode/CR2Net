...
figure('Color','w')
plot(PSetVec, detectionRate2); hold on
plot(PSetVec, detectionRate1); hold on
plot(PSetVec, detectionRate4); hold on
plot(PSetVec, detectionRate3); hold on
xlabel('Number of pilot symbols')
ylabel('Detection rate')
legend('New NN Model','Deep learning-based (legacy)','Skewness-based','Kurtosis-based','location','best')
ylim([0.5 1])
xlim([4 64])
xticks(PSetVec)
grid on
