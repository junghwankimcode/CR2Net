...
figure(6)
plot(trainSNRVec, detectionRate2); hold on
plot(trainSNRVec, detectionRate1); hold on
plot(trainSNRVec, detectionRate4); hold on
plot(trainSNRVec, detectionRate3); hold on
xlabel('SNR [dB]')
