...
for indexN = 1:length(KfactorVec)

    Kfactor= KfactorVec(indexN);
    testDoF = trainDoF;
...
figure(6)
plot(KfactorVec, detectionRate2); hold on
plot(KfactorVec, detectionRate1); hold on
plot(KfactorVec, detectionRate4); hold on
plot(KfactorVec, detectionRate3); hold on
xlabel('K-factor')
